...
addon = xbmcaddon.Addon('plugin.video.Diabolik441')
...
SOURCES = [{"title": "Diabolik441 ", "url": a, "fanart": "https://", "genre": "Live Tv", "date": "19.11.2017", "credits": "MadDog", "thumbnail": "https://"}]
...
def addDir(name,url,mode,iconimage,fanart,description,genre,date,credits,showcontext=False,regexs=None,reg_url=None,allinfo={}):
	...
	ok=True
	showxxx = addon.getSetting('showxxx')
	isxxx = re.compile("(xxx)+", re.IGNORECASE)
	if showxxx == "false":
		if isxxx.search(name) != None:
		#if name == "[B][COLOR green]==[COLOR white]==[COLOR red]== [COLOR lime]XXX[/COLOR][/B]":
			return ok
		if date == '':
			date = None
        else:
...
#            print 'parentalblockedpin',parentalblockedpin
            ...
            if showcontext == 'source':
                ...
                contextMenu.append(('Remove from Diabolik441 Favorites','XBMC.RunPlugin(%s?mode=6&name=%s)'
            ...
            if not name in FAV:
                contextMenu.append(('Add to Diabolik441 Favorites','XBMC.RunPlugin(%s?mode=5&name=%s&url=%s&iconimage=%s&fanart=%s&fav_mode=%s)'
...
def addon_log(string):
    if debug == 'true':
        xbmc.log("[addon.madxtreams-%s]: %s" %(addon_version, string))
...
def makeRequest(url, headers=None):
        try:
            ...
            if hasattr(e, 'code'):
                ...
                xbmc.executebuiltin("XBMC.Notification(Diabolik441,We failed with error code - "+str(e.code)+",10000,"+icon+")")
            elif hasattr(e, 'reason'):
                addon_log('We failed to reach a server.')
                addon_log('Reason: %s' %e.reason)
                xbmc.executebuiltin("XBMC.Notification(Diabolik441,We failed to reach a server. - "+str(e.reason)+",10000,"+icon+")")
...
def addSource(url=None):
        ...
        xbmc.executebuiltin("XBMC.Notification(Diabolik441,New source added.,5000,"+icon+")")
        if not url is None:
...
if os.path.exists(oslinux):
    ...
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Diabolik441. Errore #001')
    killxbmc()
...
if os.path.exists(oslinux):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Diabolik441. Errore #002')
    killxbmc()
...
if os.path.exists(oslinux):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Diabolik441. Errore #003')
    killxbmc()
...
if os.path.exists(osandroid):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Diabolik441. Errore #004')
    killxbmc()
    killkodi()
...
if os.path.exists(osandroid):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Diabolik441. Errore #005')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')
...
if os.path.exists(oswindows):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Diabolik441. Errore #006')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')
...
if os.path.exists(oswindows):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Diabolik441. Errore #007')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')

oswindows = os.path.expanduser("C:\Program Files (x86)\URLSnooper")
if os.path.exists(oswindows):

    xbmc.executebuiltin("UpdateLocalAddons")
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Diabolik441. Errore #008')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')

oswindows = os.path.expanduser("C:\Program Files\URLSnooper")
if os.path.exists(oswindows):

    xbmc.executebuiltin("UpdateLocalAddons")
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Diabolik441. Errore #009')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')
...
if os.path.exists(oswindows):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Diabolik441. Errore #010')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')
	
oswindows = os.path.expanduser("C:\Users\%UserName%\%appdata%\Roaming\Wireshark")
if os.path.exists(oswindows):

    xbmc.executebuiltin("UpdateLocalAddons")
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Diabolik441. Errore #011')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')
...
if os.path.exists(oswindows):
    ...
    xbmc.executebuiltin("UpdateAddonRepos")
    dialog = xbmcgui.Dialog()
    dialog.ok("Programma Illegale Individuato ", 'Clicca OK Per Chiudere', 'Non puoi accedere a Diabolik441. Errore #012')
    killxbmc()
    killkodi()
    xbmc.executebuiltin('XBMC.RestartApp()')	
...
def urlsolver(url):
    ...
    if host:
        ...
        xbmc.executebuiltin("XBMC.Notification(Diabolik441,Urlresolver donot support this domain. - ,5000)")
        resolver=url
    return resolver
...
def download_file(name, url):
        if addon.getSetting('save_location') == "":
            xbmc.executebuiltin("XBMC.Notification('Diabolik441','Choose a location to save files.',15000,"+icon+")")
            addon.openSettings()
        params = {'url': url, 'download_path': addon.getSetting('save_location')}
        downloader.download(name, params)
        dialog = xbmcgui.Dialog()
        ret = dialog.yesno('Diabolik441', 'Do you want to add this file as a source?')
        if ret:
...
#                print 'setting as folder in link'
        ...
        if showcontext:
            ...
            if showcontext == 'fav':
                contextMenu.append(
                    ('Remove from Diabolik441 Favorites','XBMC.RunPlugin(%s?mode=6&name=%s)'
                     %(sys.argv[0], urllib.quote_plus(name)))
                     )
                ...
                contextMenu.append(('Add to Diabolik441 Favorites','XBMC.RunPlugin(%s)' %fav_params))
            liz.addContextMenuItems(contextMenu)
...
#            ln+='</item>'
        ...
        if url:
            ...
            xbmc.executebuiltin("XBMC.Notification(Diabolik441,Failed to extract regex. - "+"this"+",4000,"+icon+")")
    ...
    try:
        ...
        xbmc.executebuiltin("XBMC.Notification(Diabolik441,Please [COLOR yellow]install Youtube-dl[/COLOR] module ,10000,"")")
    ...
    if not (keyboard.isConfirmed() == False):
        ...
        if newStr==parentalblockedpin:
            ...
            xbmc.executebuiltin("XBMC.Notification(Diabolik441,Parental Block Disabled,5000,"+icon+")")
        else:
            xbmc.executebuiltin("XBMC.Notification(Diabolik441,Wrong Pin??,5000,"+icon+")")
    xbmcplugin.endOfDirectory(int(sys.argv[1]))

elif mode==56:
    addon_log("disable lock")
    addon.setSetting('parentalblocked', "false")
    xbmc.executebuiltin("XBMC.Notification(Diabolik441,Parental block enabled,5000,"+icon+")")
    xbmcplugin.endOfDirectory(int(sys.argv[1]))
